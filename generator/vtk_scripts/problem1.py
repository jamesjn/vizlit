...
#Figure 1 for Visualization Literacy Project
#Python code edited with notepad
#Tested for compatibility with vtkpython (vtk version 5.4.2)

"""
Version History

0.1		JC	Initial Version

"""

#importing the necessary vtk package to access vtk functions
import vtk
import time
